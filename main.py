...
if __name__ == "__main__":
    ...
    # https://www.interactivebrokers.co.uk/oauth/#/configuration
    access_token = 'get from the self-service portal: https://www.interactivebrokers.co.uk/oauth/#/configuration'
    access_token_secret = 'get from the self-service portal : https://www.interactivebrokers.co.uk/oauth/#/configuration'
